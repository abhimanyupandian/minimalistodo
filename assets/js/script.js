...
(function(){
  ...
  if(localStorage.getItem("today")) {
    var currentdate = new Date(); 
    olddate = JSON.parse(localStorage.getItem("today")); 
    if (parseInt(currentdate.getTime()/1000000) != olddate) {
      
    }
  }
  localStorage.setItem("today", parseInt(currentdate.getTime()/1000000));
})();
